...
<a href="removestaff.php" class="list-group-item ">Remove Staff Member</a>
</div>
</div>
<div class="col-md-8">
<div class="card">
<div class="card-body" style="background-color:#3498DB;color:#ffffff;">
<h3>Remove Staff Details</h3>
</div>
<div class="card-body">
<form class="form-group" action="func.php" method="post">
<label>Staff Id :</label>
<input type="text" name="staffid" class="form-control"><br>
<input type="submit" class="btn btn-primary" name="staff_remove" value="Remove">
</form>
</div>
</div>
</div>
