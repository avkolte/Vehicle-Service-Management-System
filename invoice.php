...
<div class="card-body">
<form class="form-group" action="receipt.php" target="_blank" method="post">
<label>Aadhar Id :</label>
<input type="text" name="aadharid" class="form-control"><br>

<label>Pay Amount:</label>
<input type="text" name="payamount" class="form-control"><br>
<label>Invoice No:</label>
<input type="text" name="invoiceno" class="form-control"><br>
<label>Date:</label>
<input type="date" name="date" class="form-control"><br>
<input type="submit" class="btn btn-primary" name="bill_submit" value="Invoice">
</form>
</div>
</div>
</div>
